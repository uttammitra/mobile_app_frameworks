...
class CSSCallbacksRegistry {
  ...
  dispatch(events) {
    ...
    for (const event of events) {
      const subscribers = subscribersFor(event.tag, this.subscribersByTag, retiring);
...
function addSubscriber(byTag, viewTag, subscriber) {
...
function subscribersFor(viewTag, subscribed, retiring) {
...
//# sourceMappingURL=CSSCallbacksRegistry.js.map