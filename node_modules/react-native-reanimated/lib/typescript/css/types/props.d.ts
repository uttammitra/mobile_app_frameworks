...
import type { CSSAnimationCallbacks, CSSAnimationProperties } from './animation';
...
type CSSConfigProps<TStyle extends object = UnknownRecord> = Partial<CSSAnimationProperties<TStyle> & CSSTransitionProperties<TStyle>>;
export type CSSCallbackProps = Partial<CSSAnimationCallbacks & CSSTransitionCallbacks>;
