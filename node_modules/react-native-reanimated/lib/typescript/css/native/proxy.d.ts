...
export declare function setCSSEventHandler(handler: CSSEventHandler): void;
...
export declare function runCSSTransition(shadowNodeWrapper: ShadowNodeWrapper, transitionConfig: CSSTransitionConfig, eventMask: number): void;
