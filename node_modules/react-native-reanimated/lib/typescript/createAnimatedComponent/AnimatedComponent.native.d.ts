...
export default class AnimatedComponent extends ReanimatedAnimatedComponent<AnimatedComponentProps<InitialComponentProps>, {
    ...
    _syncStylePropsBackToReact(settledUpdates: StyleProps): void;
    _detachStyles(): void;
    ...
    componentDidUpdate(prevProps: AnimatedComponentProps<InitialComponentProps>): void;
...
//# sourceMappingURL=AnimatedComponent.native.d.ts.map