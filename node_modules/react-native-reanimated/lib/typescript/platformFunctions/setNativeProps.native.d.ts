...
type SetNativeProps = <TRef extends InstanceOrElement>(animatedRef: AnimatedRef<TRef>, updates: StyleProps) => void;
/**
...
export {};
//# sourceMappingURL=setNativeProps.native.d.ts.map