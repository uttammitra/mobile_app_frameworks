 ...
 */
export declare function useHandler<Event extends object, Context extends UnknownRecord>(handlers: GeneralHandlers<Event, Context>, _dependencies?: DependencyList): UseHandlerContext<Context>;
//# sourceMappingURL=useHandler.native.d.ts.map